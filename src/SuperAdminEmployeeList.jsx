...
function App() {
  ...
  const getDATA = async () => {
    ...
    setLoading(true);
    const userApi = "api/users/getSuperAdminEmployees";
    try {
  ...
  return (
    <>
      <div className="p-6">
        <Tabs>
          <TabList className="flex bg-gray-200 p-4 rounded-lg">
            <Tab className=" bg-gray-200 hover:text-gray-900 px-4 py-2 font-semibold rounded-lg cursor-pointer">
              Employee List
            </Tab>
          </TabList>
