...
function App() {
    ...
    return (
        <div className="flex flex-col items-center min-h-screen p-8 md:p-12 ">
            <div className="flex flex-col md:flex-row justify-start bg-black items-center w-full max-w-6xl rounded-lg shadow-lg overflow-hidden">
                <div className="flex flex-col items-center md:items-start w-full md:w-1/2 p-8">
                ...
                {fileData && file && (
                    <div className="flex justify-center items-center w-full md:w-1/3 mt-4 md:mt-0 md:ml-8">
                        <div className="shadow-lg p-6 bg-white rounded-lg w-full">
                            ...
                            <p className="text-gray-600 mb-2">
                                <span className="font-bold">FILE SIZE:</span> {(file.size / (1024 * 1024)).toFixed(4)} MB
                            </p>
            ...
            {fileData && header.length > 0 && (
                <div className="mt-8 w-full max-w-6xl">
                    <h2 className="text-xl md:text-2xl text-gray-900 mb-4 text-center">Headers Found In Your File</h2>
