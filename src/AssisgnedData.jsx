...
function App() {
    ...
    const columns = [
...

        {
            ...
            cell: (row) => (
                <button
                    className={`focus:outline-none text-white bg-${row.isApproved === 1 ? "green" : "red"
                        }-700 hover:bg-${row.isApproved === 1 ? "green" : "red"
                        }-800 focus:ring-4 focus:ring-${row.isApproved === 1 ? "green" : "red"
