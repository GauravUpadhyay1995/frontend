                                                ...
                                                <div className="relative">
                                                    <div className="chat-messages p-4 overflow-auto " key={index}>
                                                        <div className="flex py-3 px-4 border-t">
                                                            ...
                                                            />
                                                            <label htmlFor="file" style={{ paddingTop: "14px" }} className="bg-blue-500 text-white pl-2 py-2 cursor-pointer">
                                                                <CgAttachment />
                                                            </label>
                                                            <button className="bg-blue-500 text-white  px-4 py-2" onClick={() => { handleSend(escalationData[key][0].escalation_id) }}>Send</button>
                                                            <label title="Close this escalation" style={{ paddingTop: "14px" }} className="bg-red-500 cursor-pointer text-white rounded-r-lg px-2 "
                                                                onClick={() => { openModal(escalationData[key][0].escalation_id) }}
                                                            >
