  ...
  const columns = [
    {
      ...
      cell: (row, index) => {
        if (index === editingIndex) {
          return (
            <input
              className="appearance-none block w-full text-gray-700 border border-gray-300 rounded py-2 px-3 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500"
              ref={inputRef}
              type="text"
